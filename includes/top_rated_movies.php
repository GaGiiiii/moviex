 ...
 <section id="top-rated-movies" class="mt-5">
   <div class="container">
     ...
     <div class="owl-carousel owl-theme mt-5">
       ...
       <?php foreach ($moviesSortedByRating as $movie) : ?>
         <div class="item mr-4 text-center">
           <img type="button" data-toggle="modal" data-target="#movie-modal<?php echo $movie['id']; ?>" src="<?php echo $movie['img']; ?>" alt="Banner1">
           <h3 class="text-center movie-title mt-3"><?php echo $movie['title']; ?></h3>
